...
const customer_controller_1 = __importDefault(
...
router
  .route("/")
  .get(
    auth_controller_1.default.protectRoute,
    customer_controller_1.default.getAllCustomers
  );
router
  .route("/:id")
  ...
  .delete(
    auth_controller_1.default.protectRoute,
    auth_controller_1.default.restrictTo("admin"),
    customer_controller_1.default.deleteCustomerById
  );
